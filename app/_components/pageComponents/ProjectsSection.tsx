...
//   const { projects: projectsData, isLoading: loading } = useAppSelector(
//     (state) => state.project
//   );
...
//             scalable applications with great user experiences
//           </p>
...
//                         {/* Overlay on hover */}
//                         <motion.div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center p-6 sm:p-8">
...
//                 {(filter === "all" ? otherProjects : featuredProjects).map(
//                   (project, index) => (
//                     <motion.div
//                       key={project._id}
//                       initial={{ opacity: 0, y: 30 }}
...
//                         {/* Overlay on hover (desktop / sm+ only) */}
//                         <motion.div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/80 to-transparent hidden sm:flex opacity-0 group-hover:opacity-100 transition-opacity duration-500 items-end justify-center p-6 sm:p-8 ">
//                           <div className="flex gap-3 sm:gap-4 ">
//                             {project.githubUrl && (
//                               <motion.a
//                                 href={
...
//                           {/* Buttons - mobile (below technologies) */}
//                           <div className="flex gap-3 sm:gap-4 ">
//                             {project.githubUrl && (
//                               <motion.a
//                                 href={
                        ...
                        >
                          ...
                          <div className="flex gap-3 sm:gap-4 md:hidden">
                            <motion.a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-2 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-slate-800/90 backdrop-blur-xl border border-slate-700/50 hover:border-blue-500/50 text-slate-300 hover:text-blue-400 transition-all duration-300 shadow-lg"
                              whileHover={{ scale: 1.1, y: -5 }}
                              whileTap={{ scale: 0.95 }}
                            >
                              <Code className="w-4 h-4 sm:w-5 sm:h-5" />
